...
(function() {
  var EventEmitter, T, TermUI, hex, keypress, rgb, rgb5, tty, util, _,
    _this = this,
  ...
  module.exports = T = new (TermUI = (function(_super) {
    ...
    function TermUI() {
      ...
      this.handleData = function(d) {
        return TermUI.prototype.handleData.apply(_this, arguments);
      };
      this.handleKeypress = function(c, key) {
        return TermUI.prototype.handleKeypress.apply(_this, arguments);
      };
      this.handleSizeChange = function() {
        return TermUI.prototype.handleSizeChange.apply(_this, arguments);
      };
