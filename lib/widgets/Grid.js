...
(function() {
  ...
  T.Grid = (function(_super) {
    ...
    Grid.prototype.draw = function() {
      ...
      y = 0;
      _results = [];
      for (row = _i = 0, _ref = this.cellHeight + 1; _ref > 0 ? _i <= maxRow : _i >= maxRow; row = _i += _ref) {
        r = this.rowStyle(row + (this.cellHeight * row));
        x = 0;
        for (col = _j = 0, _ref1 = this.cellWidth + 1; _ref1 > 0 ? _j <= maxCol : _j >= maxCol; col = _j += _ref1) {
